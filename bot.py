...
"""
    ...
    elif texto == '/test_alerta' or texto == '🔔 Probar Alerta':
        if chat_id == ADMIN_ID:
            test_alerta(chat_id)
        else:
            enviar_mensaje(chat_id, "❌ Solo el administrador")
