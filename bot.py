...
usuario_esperando_tasa_mesa = {}
usuario_tasa_mesa = {}
usuario_modo_calculo = {}  # 'bcv' o 'mesa_cambio'
usuario_monto_temporal = {}
...
def crear_teclado_comisiones():
    """Genera el menú interactivo para elegir directamente el % de comisión."""
    teclado = [
        [
...
def procesar_callback_inline(call):
    ...
    if data.startswith("pct:"):
        ...
        etiqueta = f"Comisión {pct_tarjeta}%"
    ...
    if usuario_esperando_tasa_mesa.get(user_id, False):
        try:
            ...
            enviar_mensaje(
                chat_id,
                msg,
                teclado=crear_teclado_comisiones(),
                tipo="inline",
            )
            return
        except ValueError:
